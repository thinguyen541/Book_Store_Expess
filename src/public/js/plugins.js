...
!(function (t, e) {
    ...
    var Y = {
        ...
        X = function (n, f) {
            var o = this;
            if (('string' == typeof n && (n = Q.querySelector(n)), !n))
                return !1;
            ...
            var u = function () {
                ...
                r = {
                    ...
                    stick: function () {
                        ...
                        d.hasClass(n, p.stickyClass) ||
                            ...
                            p.onStart &&
                                p.onStart.call(n, Object.assign({}, p)));
                    },
                    release: function () {
                        var t =
                            0 < arguments.length && void 0 !== arguments[0]
                        ...
                        if (
                            ...
                            !0 === t.stop ||
                                ...
                                !(
                                    ...
                                    (void 0 !== t.top &&
                                        (parseInt(d.getStyle(n, 'top')) ||
                                            0) === t.top) ||
                                    (void 0 !== t.bottom &&
                                        (parseInt(d.getStyle(n, 'bottom')) ||
                                            0) === t.bottom)
                                ))
                        ) {
                            !0 === t.stop
                            ...
                            (r.position = e),
                                ...
                                (n.style.left =
                                    !0 === t.stop
                                        ...
                                        : l.positionLeft + 'px'),
                                (n.style.width =
                                    'absolute' !== e ? r.css.width : l.width),
                                void 0 === t.bottom
                                    ? (n.style.bottom =
                                          !0 === t.stop ? '' : 'auto')
                                    : (n.style.bottom = t.bottom + 'px'),
                                ...
                                p.onStop &&
                                    p.onStop.call(n, Object.assign({}, p));
                        }
                    },
                },
                l = {
                    ...
                    init: function () {
                        ...
                        var e = d.getStyle(n);
                        (l.offsetLeft =
                            d.offset(n).left - (parseInt(e.marginLeft) || 0)),
                ...
                q = function () {
                    null !== n.offsetParent &&
                    'none' !== d.getStyle(n, 'display')
                        ? (i(),
                          m <= T
                              ? I()
                              : (R(),
                                A || (d.event.bind(U, 'scroll', R), (A = !0))))
                        : I();
                },
                F = function () {
                    (n.style.position = ''),
        ...
        t.Helpers = {
            ...
            getCascadedStyle: function (t) {
                ...
                e.currentStyle
                    ? (o = e.currentStyle)
                    : c.getComputedStyle &&
                      (o = f.defaultView.getComputedStyle(e, null));
                var i = {};
                for (var n in o)
                    !isNaN(n) ||
            ...
            _createClass(e, [
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        ...
                        t <= 0 ||
                            setTimeout(function () {
                                (o.scrollDoc.scrollTop =
                                    o.scrollDoc.scrollTop + n),
                                    o.scrollDoc.scrollTop != e &&
                                        o.scrollTo(e, t - 1);
                            }, 1);
                    },
                },
